...
- :ref:`OfxPropHostBuildVersion <prop_OfxPropHostBuildVersion>` - Type: string, Dimension: 1 (doc: :c:macro:`kOfxPropHostBuildVersion`)
- :ref:`OfxPropHostMajorVersion <prop_OfxPropHostMajorVersion>` - Type: int, Dimension: 1 (doc: :c:macro:`kOfxPropHostMajorVersion`)
- :ref:`OfxPropHostMinorVersion <prop_OfxPropHostMinorVersion>` - Type: int, Dimension: 1 (doc: :c:macro:`kOfxPropHostMinorVersion`)
- :ref:`OfxPropHostOSHandle <prop_OfxPropHostOSHandle>` - Type: pointer, Dimension: 1 (doc: :c:macro:`kOfxPropHostOSHandle`)
- :ref:`OfxPropHostProductTitle <prop_OfxPropHostProductTitle>` - Type: string, Dimension: 1 (doc: :c:macro:`kOfxPropHostProductTitle`)
- :ref:`OfxPropLabel <prop_OfxPropLabel>` - Type: string, Dimension: 1 (doc: :c:macro:`kOfxPropLabel`)
- :ref:`OfxPropName <prop_OfxPropName>` - Type: string, Dimension: 1 (doc: :c:macro:`kOfxPropName`)
- :ref:`OfxPropType <prop_OfxPropType>` - Type: string, Dimension: 1 (doc: :c:macro:`kOfxPropType`)
- :ref:`OfxPropVersion <prop_OfxPropVersion>` - Type: int, Dimension: Variable (doc: :c:macro:`kOfxPropVersion`)
...
- :ref:`OfxParamPropLayoutHint <prop_OfxParamPropLayoutHint>` - Type: int, Dimension: 1 (doc: :c:macro:`kOfxParamPropLayoutHint`)
- :ref:`OfxParamPropLayoutPadWidth <prop_OfxParamPropLayoutPadWidth>` - Type: int, Dimension: 1 (doc: :c:macro:`kOfxParamPropLayoutPadWidth`)
...
- :ref:`OfxParamPropDataPtr <prop_OfxParamPropDataPtr>` - Type: pointer, Dimension: 1 (doc: :c:macro:`kOfxParamPropDataPtr`)
- :ref:`OfxParamPropEnabled <prop_OfxParamPropEnabled>` - Type: bool, Dimension: 1 (doc: :c:macro:`kOfxParamPropEnabled`)
- :ref:`OfxParamPropGroupIsTab <prop_OfxParamPropGroupIsTab>` - Type: bool, Dimension: 1 (doc: :c:macro:`kOfxParamPropGroupIsTab`)

...
namespace OFX {
  ...
  int 
  PropertySet::propGetDimension(const std::string &property) const throw(OFX::Exception)
  {
  ...
  void
  PropertySet::propReset(const std::string &property) throw(OFX::Exception)
  {
    assert(_propHandle != 0);
  ...
  void 
  PropertySet::propSetPointer(const std::string &property, void *value, int idx) throw(OFX::Exception)
  {
    assert(_propHandle != 0);
  ...
  void 
  PropertySet::propSetString(const std::string &property, const std::string &value, int idx) throw(OFX::Exception)
  {
    assert(_propHandle != 0);
  ...
  void 
  PropertySet::propSetDouble(const std::string &property, double value, int idx) throw(OFX::Exception)
  {
    assert(_propHandle != 0);
  ...
  void 
  PropertySet::propSetInt(const std::string &property, int value, int idx) throw(OFX::Exception)
  {
    assert(_propHandle != 0);
  ...
  void  *
  PropertySet::propGetPointer(const std::string &property, int idx) const throw(OFX::Exception)
  {
    assert(_propHandle != 0);
    void *value;
  ...
  std::string 
  PropertySet::propGetString(const std::string &property, int idx) const throw(OFX::Exception)
  {
    assert(_propHandle != 0);
    char *value;
  ...
  double      
  PropertySet::propGetDouble(const std::string &property, int idx) const throw(OFX::Exception)
  {
    assert(_propHandle != 0);
    double value;
  ...
  int         
  PropertySet::propGetInt(const std::string &property, int idx) const throw(OFX::Exception)
  {
    assert(_propHandle != 0);
    int value;
  ...
  // get multiple values
  void propGetPointerN(const std::string &property, std::vector<void *> &values,      int N) const throw(OFX::Exception);;
  void propGetStringN(const std::string &property,  std::vector<std::string> &values, int N) const throw(OFX::Exception);;
  void propGetDoubleN(const std::string &property,  std::vector<double> &values,      int N) const throw(OFX::Exception);;
  void propGetIntN(const std::string &property,     std::vector<int> &values,         int N) const throw(OFX::Exception);;
#endif

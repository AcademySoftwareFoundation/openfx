...
This is a guide to the basic machinery for writing an OFX plugin and some of the fundamentals of the API. 
The basic plugin machinery establishes communications between a plugin and a host application.
...
The makefile for our example plugin will place it in the correct directory structure for distribution.

...
/** @brief log file, yes I know, it could be an iostream, but I hate iostreams, call me an
 * old fashion C programmer */
static FILE *gLogFP = 0;
static std::string gLogFileName("ofxTestLog.txt");

/** @brief Sets the name of the log file. */
void logSetFileName(const std::string &value) { gLogFileName = value; }

/** @brief Gets the name of the log file. */
const std::string &logGetFileName() { return gLogFileName; }

...
{ "ImageEffectHost", {
   ...
   { "OfxPropHostProductTitle", prop_defs[PropId::OfxPropHostProductTitle], true, false, false },
   { "OfxPropHostMajorVersion", prop_defs[PropId::OfxPropHostMajorVersion], true, false, false },
   { "OfxPropHostMinorVersion", prop_defs[PropId::OfxPropHostMinorVersion], true, false, false },
   { "OfxPropHostBuildVersion", prop_defs[PropId::OfxPropHostBuildVersion], true, false, false },
...
{ "ParamDouble1D", {
   ...
   { "OfxParamPropLayoutHint", prop_defs[PropId::OfxParamPropLayoutHint], false, true, false },
   { "OfxParamPropLayoutPadWidth", prop_defs[PropId::OfxParamPropLayoutPadWidth], false, true, false },
...
{ "ParamsGroup", {
   ...
   { "OfxParamPropGroupIsTab", prop_defs[PropId::OfxParamPropGroupIsTab], false, true, false },
   { "OfxPropType", prop_defs[PropId::OfxPropType], false, true, false },
   { "OfxPropName", prop_defs[PropId::OfxPropName], false, true, false },
   { "OfxPropLabel", prop_defs[PropId::OfxPropLabel], false, true, false },
   { "OfxPropShortLabel", prop_defs[PropId::OfxPropShortLabel], false, true, false },

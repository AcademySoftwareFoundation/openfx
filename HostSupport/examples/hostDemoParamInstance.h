...
namespace MyHost {
  ...
  public:
    MyIntegerInstance(MyEffectInstance* effect, MyParamSetInstance* paramSet, const std::string& name, OFX::Host::Param::Descriptor& descriptor);
    OfxStatus get(int&);
  ...
  protected:
    ...
    OFX::Host::Param::Descriptor& _descriptor;
  public:
    MyDoubleInstance(MyEffectInstance* effect, MyParamSetInstance* paramSet, const std::string& name, OFX::Host::Param::Descriptor& descriptor);
  ...
  protected:
    ...
    OFX::Host::Param::Descriptor& _descriptor;
  public:
    MyBooleanInstance(MyEffectInstance* effect, MyParamSetInstance* paramSet, const std::string& name, OFX::Host::Param::Descriptor& descriptor);
    OfxStatus get(bool&);
  ...
  protected:
    ...
    OFX::Host::Param::Descriptor& _descriptor;
  public:
    MyChoiceInstance(MyEffectInstance* effect, MyParamSetInstance* paramSet, const std::string& name, OFX::Host::Param::Descriptor& descriptor);
    OfxStatus get(int&);
    OfxStatus get(OfxTime time, int&);
    OfxStatus set(int);
    OfxStatus set(OfxTime time, int);
  ...
  protected:
    ...
    OFX::Host::Param::Descriptor& _descriptor;
  public:
    MyRGBAInstance(MyEffectInstance* effect, MyParamSetInstance* paramSet, const std::string& name, OFX::Host::Param::Descriptor& descriptor);
  ...
  protected:
    ...
    OFX::Host::Param::Descriptor& _descriptor;
  public:
    MyRGBInstance(MyEffectInstance* effect, MyParamSetInstance* paramSet, const std::string& name, OFX::Host::Param::Descriptor& descriptor);
  ...
  protected:
    ...
    OFX::Host::Param::Descriptor& _descriptor;
  public:
    MyDouble2DInstance(MyEffectInstance* effect, MyParamSetInstance* paramSet, const std::string& name, OFX::Host::Param::Descriptor& descriptor);
  ...
  protected:
    ...
    OFX::Host::Param::Descriptor& _descriptor;
  public:
    MyInteger2DInstance(MyEffectInstance* effect, MyParamSetInstance* paramSet, const std::string& name, OFX::Host::Param::Descriptor& descriptor);
